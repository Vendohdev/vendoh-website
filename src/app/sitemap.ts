...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/faq`,             priority: 0.8, changeFrequency: "monthly", lastModified: now },
    { url: `${SITE}/features`,        priority: 0.9, changeFrequency: "monthly", lastModified: now },
    { url: `${SITE}/vendors`,         priority: 0.9, changeFrequency: "monthly", lastModified: now },
