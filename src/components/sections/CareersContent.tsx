...
export function CareersContent() {
  return (
    <>
      {/* HERO — powder cornflower blue */}
      <section className="relative overflow-hidden bg-[#E6EBFD] pt-32 pb-20 sm:pt-40 sm:pb-24">
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#536DEF]/15 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-vendoh-orange/10 rounded-full blur-3xl pointer-events-none" />
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 text-center">
          <motion.div {...fadeUp}>
            <p className="text-sm font-extrabold text-vendoh-orange uppercase tracking-wider mb-4">
              Hiring soon
            </p>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#2B3A8F] leading-[1.1]">
              Build the Future of{" "}
              <span className="text-vendoh-orange relative inline-block">
                Service in Africa
                <Squiggle className="absolute -bottom-3 left-0 w-full h-3 text-[#536DEF]/50" />
              </span>
              <Starburst size={28} className="inline-block ml-3 -mt-8 text-[#536DEF] animate-pulse" />
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-[#4A5AB5] max-w-2xl mx-auto leading-relaxed">
